...
export default function Hotel() {
    return (
        <div>
            ...
            <div className="grid grid-cols-3 h-48 gap-3 w-full rounded-md bg-white max-md:grid-cols-1 max-ms:hidden max-md:w-96" style={{ width: '50rem' }}>
...
<div className="text-left">
                    ...
                    <button className="flex bg-blue hover:bg-blue2 w-40 text-white p-3 rounded-md relative top-16 right-16">
                        مشاهده اتاق ها
                        <div className='w-2 relative top-1 right-8'><ArrowLeft /></div>
                        </button>
                    </div>
            </div>
